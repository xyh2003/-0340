...
public class MessageFactory {
    ...
    private static List<WxMpTemplateData> buildData(Friend friend) {
        ...
        return List.of(
                ...
                TemplateDataBuilder.builder().name("nextBirthday").value("距离"+friend.getFullName()+"下一次生日："+friend.getNextBirthdayDays()+" 天").color("#771F06").build(),
                ...
                TemplateDataBuilder.builder().name("reporttime").value(reporttime).color("#F53F3F").build()
        );
    }
